...
import com.cm.rotator.domain.rotator.model.obj.rotator.iface.ICountryurlcampaign;
...
public class Countryurlcampaign implements Cloneable, Serializable, IPojoGenEntity, ICountryurlcampaign {
	...
	/** Constructor taking a given ID.
	 * @param advertiserId Long object;
	 * @param campaignName String object;
	 * @param campaignTypeId Byte object;
	 * @param campaignUrl String object;
	 * @param campaignValue java.math.BigDecimal object;
	 * @param countryCode String object;
	 * @param id Long object;
	 * @param reportingTypeId Byte object;
	 */
	public Countryurlcampaign(Long advertiserId, String campaignName, Byte campaignTypeId, 					
			String campaignUrl, java.math.BigDecimal campaignValue, String countryCode, 					
			Long id, Byte reportingTypeId) {
    ...
    */
	...
	public boolean equals(final Object aThat) {
		...
		result = result && (((getCampaignName() == null) && (that.getCampaignName() == null)) || (getCampaignName() != null && getCampaignName().equals(that.getCampaignName())));
		result = result && (((getCampaignTypeId() == null) && (that.getCampaignTypeId() == null)) || (getCampaignTypeId() != null && getCampaignTypeId().equals(that.getCampaignTypeId())));
		result = result && (((getCampaignUrl() == null) && (that.getCampaignUrl() == null)) || (getCampaignUrl() != null && getCampaignUrl().equals(that.getCampaignUrl())));
		result = result && (((getCampaignValue() == null) && (that.getCampaignValue() == null)) || (getCampaignValue() != null && getCampaignValue().equals(that.getCampaignValue())));
		result = result && (((getCountryCode() == null) && (that.getCountryCode() == null)) || (getCountryCode() != null && getCountryCode().equals(that.getCountryCode())));
		result = result && (((getReportingTypeId() == null) && (that.getReportingTypeId() == null)) || (getReportingTypeId() != null && getReportingTypeId().equals(that.getReportingTypeId())));
		return result;
	}
