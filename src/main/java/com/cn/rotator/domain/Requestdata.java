...
import com.cm.rotator.domain.rotator.model.obj.rotator.iface.IRequestdata;
...
public class Requestdata implements Cloneable, Serializable, IPojoGenEntity, IRequestdata {
	 ...
	 * @param httpReferer String object;
	 * @param id Long object;
	 * @param ip String object;
	 * @param pathTranslated String object;
	 * @param port Integer object;
	 * @param requestMethod String object;
	 * @param requestUri String object;
	 * @param userAgent String object;
	 */
	public Requestdata(String countryCode, Date createdAt, String httpReferer, 					
			Long id, String ip, String pathTranslated, 					
			Integer port, String requestMethod, String requestUri, 					
			String userAgent) {
    ...
    */
	...
	public boolean equals(final Object aThat) {
		...
		result = result && (((getPathTranslated() == null) && (that.getPathTranslated() == null)) || (getPathTranslated() != null && getPathTranslated().equals(that.getPathTranslated())));
		result = result && (((getPort() == null) && (that.getPort() == null)) || (getPort() != null && getPort().equals(that.getPort())));
		result = result && (((getRequestMethod() == null) && (that.getRequestMethod() == null)) || (getRequestMethod() != null && getRequestMethod().equals(that.getRequestMethod())));
		result = result && (((getRequestUri() == null) && (that.getRequestUri() == null)) || (getRequestUri() != null && getRequestUri().equals(that.getRequestUri())));
		result = result && (((getUserAgent() == null) && (that.getUserAgent() == null)) || (getUserAgent() != null && getUserAgent().equals(that.getUserAgent())));
		return result;
	}
