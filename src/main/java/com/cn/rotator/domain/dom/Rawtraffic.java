...
public class Rawtraffic implements Cloneable, Serializable {
	 ...
	 *            String object;
	 */
	public Rawtraffic(String countryCode, Long countryUrlCampaignId,
			Date createdAt, Long id, Long publisherId, String publisherUid) {
	 ...
	 * 
	 * @param publisherUid
	 *            the publisherUid value you wish to set
	 */
	...
	public boolean equals(final Object aThat) {
		...
		result = result
				&& (((getPublisherUid() == null) && (that.getPublisherUid() == null)) || (getPublisherUid() != null && getPublisherUid()
						.equals(that.getPublisherUid())));
		result = result
