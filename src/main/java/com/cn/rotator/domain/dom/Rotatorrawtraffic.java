...
public class Rotatorrawtraffic implements Cloneable, Serializable {
	 ...
	 * @param rotatorDestinationPathId
	 *            Long object;
	 * @param url
	 *            String object;
	 */
	public Rotatorrawtraffic(Date createdAt, Integer id, String ip,
			java.math.BigDecimal pathPercent, Long rotatorDestinationPathId,
			String url) {
	 ...
	 * 
	 * @param rotatorDestinationPathId
	 *            the rotatorDestinationPathId value you wish to set
	 */
	...
	public String toString() {
		...
		sb.append("rotatorDestinationPathId: "
				+ this.getRotatorDestinationPathId() + ", ");
	...
	public boolean equals(final Object aThat) {
		...
		result = result
				&& (((getRotatorDestinationPathId() == null) && (that
						.getRotatorDestinationPathId() == null)) || (getRotatorDestinationPathId() != null && getRotatorDestinationPathId()
						.equals(that.getRotatorDestinationPathId())));
		result = result
